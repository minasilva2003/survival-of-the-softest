...
from utils.data_utils import write_to_csv_file, create_directory, plot_graph, save_best_robot, save_best_controller, average_csv_files
from evogym import EvoViewer, get_full_connectivity, is_connected
import cma
import time
from utils.GA_utils import create_random_robot, standard_mutate, standard_tournament_selection, one_point_crossover
...
class CoEvolutionGA_CMAES:
    ...
    def alter_robot_population(self, fitnesses):
        ...
        while len(new_population) < self.population_size:
            ...
            ### Step 2: crossover (only allow connected individuals)
            ...
            ### Step 3: mutation (only allow connected individuals)
    ...
    def co_evolution(self, run_number):
        ...
        for gen in range(self.num_generations):
            ...
            elif self.pairing_strategy == "round_robin":
