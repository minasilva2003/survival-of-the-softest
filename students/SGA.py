...
from utils.GA_utils import evaluate_fitness, create_random_robot, standard_mutate, one_point_crossover, standard_tournament_selection, simulate_and_save
...
if __name__ == "__main__":
    ...
    ga = GeneticAlgorithm(num_generations=100, 
                          ...
                          directory="results/SGA/Walker-v0/")
    ...
    ga = GeneticAlgorithm(num_generations=100, 
                          ...
                          controller=alternating_gait,
                          directory="results/SGA/BridgeWalker-v0/")
