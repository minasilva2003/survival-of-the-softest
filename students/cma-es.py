...
class CMA_ES_Controller:
    def __init__(self, population_size=50, num_generations=10, steps=500, sigma=0.5, cooldown=0.995, topk=10,scenario='DownStepper-v0', seed=42, directory="results/cma-es/"):
    ...
    def cma_es_search(self, run_number):
        ...
        with open(iteration_csv, mode='w', newline='') as csv_file:
            ...
            ###### STEP 1: Initialize mean as the initial weights of the NN, and covariance matrix as I
            brain = NeuralController(self.input_size, self.output_size)
            ...
            for it in range(self.num_generations):
                ...
                # noises are drawn from a multivariate normal distribution with the cov matrix
                # each individual is generated by adding noise to the mean weights
                # sigma is a dynamic factor that allows for noise scaling (exploration vs exploitation)
...
if __name__ == "__main__":
    cma_es_algorithm = CMA_ES_Controller(population_size=50,
                                         ...
                                         directory="results/cma-es/try2/DownStepper-v0/")
